...
plt.plot(x1,u1, color = 'g', label = 'Q1 (00 mm) = 3.42  [г/с]')
plt.plot(x2,u2, color = 'r', label = 'Q2 (20 mm) = 3.5   [г/с]')
plt.plot(x3,u3, color = 'b', label = 'Q3 (30 mm) = 4.42 [г/с]')
plt.plot(x4,u4, color = 'y', label = 'Q4 (50 mm) = 4.97 [г/с]')
plt.grid(
   which='major'
)
plt.grid(
