...
ax_1.set(title = 'Расход топлива \n при 00 мм', xticks=x1, yticks=q1, color = 'g')
ax_2.set(title = 'Расход топлива \n при 20 мм', xticks=x2, yticks=q2, color = 'r')
ax_3.set(title = 'Расход топлива \n при 30 мм', xticks=x3, yticks=q3, color = 'b')
ax_4.set(title = 'Расход топлива \n при 50 мм', xticks=x4, yticks=q4, color = 'y')
plt.grid(
   which='major'
)
plt.grid(
